    ...
    window.JCCatalogSection.prototype.ChangeInfo = function(type)
    {
        ...
        if (-1 < index){
            if (!!this.obPict){
                ...
                if (!!this.offers[index].PREVIEW_PICTURE_JS){
                    obData.attrs.src = this.offers[index].PREVIEW_PICTURE_JS.SRC;
                }else{
            ...
            {
                if (!!this.offers[index].PREVIEW_PICTURE_SECOND_JS)
                {
                    BX.adjust(this.obSecondPict, {style: {backgroundImage: 'url('+this.offers[index].PREVIEW_PICTURE_SECOND_JS.SRC+')'}});
                }
                else if (!!this.offers[index].PREVIEW_PICTURE_JS.SRC)
                {
                    BX.adjust(this.obSecondPict, {style: {backgroundImage: 'url('+this.offers[index].PREVIEW_PICTURE_JS.SRC+')'}});
                }
            ...
            this.setQuantityStore(this.offers[index].MAX_QUANTITY, this.offers[index].AVAILIABLE.HTML);
            this.offerNum = index;
            ...
            // $(this.obProduct).find('.sticker_last_size').hide();
            // if(this.offers[this.offerNum].LAST_SIZE=="Y"){
            //     $(this.obProduct).find('.sticker_last_size').show();
            // }
